...
var CoockieStore = (0, _connectMongo["default"])(_expressSession["default"]);
app.set("view engine", "pug");
app.set("views", _path["default"].join(__dirname, "views")); //app.use("/uploads", express.static("uploads"));

app.use("/static", _express["default"]["static"](_path["default"].join(__dirname, "static"))); //app.use(morgan("tiny"));
